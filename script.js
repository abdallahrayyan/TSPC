(() => {
  async function fetchAnswer() {
    const KEY = "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"; // replace the text "key" (keep the quotation marks) with your API key from https://platform.openai.com/account/api-keys
