(() => {
  async function fetchAnswer() {
    const KEY = "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"; // replace the text "key" (keep the quotation marks) with your API key from https://platform.openai.com/account/api-keys
