(() => {
  async function fetchAnswer() {
    const KEY = "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; // replace the text "key" (keep the quotation marks) with your API key from https://platform.openai.com/account/api-keys
